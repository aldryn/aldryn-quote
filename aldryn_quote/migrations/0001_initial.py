...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Quote'
        db.create_table(u'aldryn_quote_quote', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('content', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('footer', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'aldryn_quote', ['Quote'])


    def backwards(self, orm):
        # Deleting model 'Quote'
        db.delete_table(u'aldryn_quote_quote')
