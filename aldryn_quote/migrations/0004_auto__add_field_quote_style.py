...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quote.style'
        db.add_column(u'aldryn_quote_quote', 'style',
                      self.gf('django.db.models.fields.CharField')(default='standard', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Quote.style'
        db.delete_column(u'aldryn_quote_quote', 'style')
    ...
    models = {
        u'aldryn_quote.quote': {
            ...
            'target': ('django.db.models.fields.CharField', [], {'default': "'_blank'", 'max_length': '50', 'blank': 'True'}),
